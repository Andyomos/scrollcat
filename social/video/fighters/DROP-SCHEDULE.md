# "Meet the Roster" — 8-Week Drop Schedule

Audience-building cadence for the crypto-rush positioning. **One fighter per week**, staggered so
each gets its own moment instead of dumping all 8. Stage from this folder; Andy posts (no auto-post).
...
## Calendar (starting Tue 2026-06-23)

| Week | Date | Fighter | Clip | Hook angle |
|------|------|---------|------|------------|
| 1 | Jun 23 | 001 Neon Blade | 01-neon-blade-captioned.mp4 | "the roster opens" — flagship dash |
| 2 | Jun 30 | 002 Shadow Gunner | 02-shadow-gunner-captioned.mp4 | ranged deletion |
| 3 | Jul 07 | 003 Phantom Archer | 03-phantom-archer-captioned.mp4 | ignores defense |
| 4 | Jul 14 | 005 Rocket Cat | 05-rocket-cat-captioned.mp4 | max damage / spectacle (mid-series pop) |
| 5 | Jul 21 | 004 Tech Mage | 04-tech-mage-captioned.mp4 | brain over brawn |
| 6 | Jul 28 | 006 Dual Wield | 06-dual-wield-captioned.mp4 | highest tempo |
| 7 | Aug 04 | 007 Thunder Claw | 07-thunder-claw-captioned.mp4 | best all-rounder (anchor) |
| 8 | Aug 11 | 008 Ninja Scat | 08-ninja-scat-captioned.mp4 | fastest / glass cannon FINALE → "roster complete, pick your main" |

## Per-platform tone (from each fighter's -caption.txt)
- **X (@Scroll_Cat):** RECOMMENDED caption. Pin the week's fighter.
...
of the 500, closed forever. Pick your main → scrollcat.org/arena." That's the conversion beat.

## OPEN before captions imply a mint
Confirm **Model A** (8 = battle-skins of existing 500, no new mint) vs **Model B** (new drop). All current
captions are Model-A-safe ("every one of the 500 is a fighter").
