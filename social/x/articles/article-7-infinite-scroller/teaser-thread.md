# Teaser Thread → drives clicks to Article 7 (post AFTER the article is published)

**Posting notes:** Attach `article-7-cover.png` to **Tweet 1**. On **Tweet 5**, replace [ARTICLE LINK] with the published X Article URL. Post as a thread. Tone: hype/collector-FOMO. Verify Supra's @ handle before posting.

---

**Tweet 1/5** (attach cover image)
```
🌈 500 ScrollCats exist.

40% are Common. 2% are Mythic.
...
```
A 1-of-1 with nothing behind it is a flex.
